<div class="col-md-9 bibliotecas-content conteudo-lateral" ng-if="bli.phpmailer"><h2 class="bibliotecas-title">Biblioteca PHP Mailer</h2><p class="primeirospassos-text">É uma biblioteca criada para envios de e-mails.<br><br>Para carregar a biblioteca, basta chamar: <code>$this->load->biblioteca('phpmailer')</code>.<br><br>Para inicar a utlização siga os passos seguintes.<br><br> <?php
...
?>'); ?><br><br>Para entender sobre os parametros, acesso: <a target="_blank" href="https://github.com/PHPMailer/PHPMailer">GITHUB PHP MAILER</a>.</p></div>