<?php
	...
	// Função que retira a acentuação de um texto
	...
	// Função que converte o texto em uma string slug
	function criaSlug( $conteudo, $substituicao='-', $ext=null )
	{
		...
		// Remove acentuação
		$conteudo= str_replace($a, $b, $conteudo );
		...
		$conteudo = preg_replace( "/[\s_]/", $substituicao, $conteudo );

		// Tranforma o texto em caixa baixa
		$conteudo = strtolower( $conteudo );

		return ( $ext ) ? $conteudo.$ext : $conteudo;
